...
2. [Madou Monogatari (Sega Saturn) KR v0.4.0.bps](https://raw.githubusercontent.com/mcpads/madou-monogatari-kr-patch/main/Madou%20Monogatari%20(Sega%20Saturn)%20KR%20v0.4.0.bps)를 다운로드합니다
3. [Floating IPS (Flips)](https://www.smwcentral.net/?p=section&a=details&id=11474) 등 BPS 패처로 원본 BIN 파일에 한글 패치를 적용합니다

### 적용 방법 (U)

1. **원본 ROM**을 준비합니다 (BIN/CUE 형식, 아래 체크섬으로 올바른 파일인지 확인)
2. [Madou Monogatari (U) (Sega Saturn) KR v0.4.0.bps](https://raw.githubusercontent.com/mcpads/madou-monogatari-kr-patch/main/Madou%20Monogatari%20(U)%20(Sega%20Saturn)%20KR%20v0.4.0.bps)를 다운로드합니다
3. [Floating IPS (Flips)](https://www.smwcentral.net/?p=section&a=details&id=11474) 등 BPS 패처로 원본 BIN 파일에 한글 패치를 적용합니다
...
#### KR 패치 파일 — Madou Monogatari (Sega Saturn) KR v0.4.0.bps

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `2144DF1C`                                                         |
| MD5      | `54e04d50df68f7dc5699d75646ac968c`                                 |
| SHA-1    | `bb683cedb0c332126d9050c12ba386f99d3a4119`                         |
| 크기     | 4,467,348 bytes (4.3 MB)                                           |

#### KR 패치 적용 후 — Madou Monogatari (Sega Saturn) KR v0.4.0.bin

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `0EFB91AB`                                                         |
| MD5      | `de6933d804031e9ceab5d5fe16241517`                                 |
...
#### KR 패치 파일 — Madou Monogatari (U) (Sega Saturn) KR v0.4.0.bps

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `2144DF1C`                                                         |
| MD5      | `5b5ea6cf5da28c64f29194b7c691074b`                                 |
| SHA-1    | `9e54783be7d2aabf6507de4e0d78dd943f238482`                         |
| 크기     | 4,467,500 bytes (4.3 MB)                                           |

#### KR 패치 적용 후 — Madou Monogatari (U) (Sega Saturn) KR v0.4.0.bin

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `1E8A4208`                                                         |
| MD5      | `62525389b221f8264d138bae90e8d669`                                 |
| 크기     | 146,308,512 bytes (139 MB)                                         |

### 패치 정보

- 베타 버전: 시나리오/이벤트 대사 번역 상태, 버그 존재 가능성
