...
> 이 패치는 선공개용 베타 버전으로 아직 검수가 끝나지 않은 상태입니다. 미번역 요소, 게임 진행에 차질이 생기는 버그가 존재할 수 있으며, 번역 역시 변경될 수 있습니다. (하드웨어 한계로 번역에서 사용 가능한 한글 개수에 제한이 있어, 현재 Codex/Claude 등을 통해 대규모 검수 단계입니다)
