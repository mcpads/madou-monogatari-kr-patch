...
2. [Madou Monogatari (Sega Saturn) KR v0.2.0.bps](https://raw.githubusercontent.com/mcpads/madou-monogatari-kr-patch/main/Madou%20Monogatari%20(Sega%20Saturn)%20KR%20v0.2.0.bps)를 다운로드합니다
...
#### KR 패치 파일 — Madou Monogatari (Sega Saturn) KR v0.2.0.bps

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `2144DF1C`                                                         |
| MD5      | `a8f22baf8c7b958695dcacef0e07cde0`                                 |
| SHA-1    | `4bff7fd9cd278c40bf55036731cc5d535d4dfdf3`                         |
| SHA-256  | `248db9c6610651c4c8040e0d837eefc627f25f8255b5723222c5b2ba2b43b4b9` |
| 크기     | 4,467,375 bytes (4.3 MB)                                           |

#### KR 패치 적용 후 — Madou Monogatari (Sega Saturn) KR v0.2.0.bin

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `3C35C1C7`                                                         |
| MD5      | `f42fc4bfb92e0cc16f0062758692453e`                                 |
| SHA-1    | `2d8eccbe6cd4d8769a74dbc7478d9229e18b8aed`                         |
| SHA-256  | `6aaa434b6002b38efe8245cbf54b1fc8dccbd87e95d5376eb76081f9fc622bb8` |
...
- **QA**: mcpads
- **원작**: Compile (1998)
- **폰트**: Galmuri, MaplestoryBold, Dalmoori
