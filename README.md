...
> 현재 패치는 선공개 베타 버전이며 테스트 중으로 여러 버그가 있을 수 있습니다.
...
1. **일본판 원본 ROM**을 준비합니다 (아래 체크섬으로 올바른 파일인지 확인)
2. [Madou Monogatari - Hanamaru Daiyouchienji (KR v0.1.0).bps](https://raw.githubusercontent.com/mcpads/madou-monogatari-kr-patch/main/Madou%20Monogatari%20-%20Hanamaru%20Daiyouchienji%20(KR%20v0.1.0).bps)를 다운로드합니다
...
#### KR 패치 파일 — Madou Monogatari - Hanamaru Daiyouchienji (KR v0.1.0).bps

| 알고리즘 | 해시                                                             |
| -------- | ---------------------------------------------------------------- |
| CRC32    | 2144DF1C                                                         |
| MD5      | bc52cfe2cc5f9b275eed20c773be163a                                 |
| SHA-1    | ef32771de100fcbfaade294fc0030a2d6a5b8dfe                         |
| SHA-256  | de1ae25a8010dfe183302b3c392097ba1741d101e51bf6b191b26ec5cb6f6307 |
| 크기     | 192,993 bytes (188 KB)                                           |

#### KR 패치 적용 후 — Madou Monogatari - Hanamaru Daiyouchienji (KR v0.1.0).sfc

| 알고리즘 | 해시                                                             |
| -------- | ---------------------------------------------------------------- |
| CRC32    | 52D09632                                                         |
| MD5      | b910b5373bcceefb1365dfabe98b9c26                                 |
| SHA-1    | dd89d91fb811b0a20d596f17c85ddc2c1a7c8e43                         |
| SHA-256  | 26460296a3e2052f01fce97f3347ae7e8f92c6a3326fff25976e4a86a62b3875 |
| 크기     | 2,097,152 bytes (2 MB)                                           |
...
- [x] 일본어 폰트 추출 및 테이블 완성: 100%
- [x] 시나리오 텍스트 추출: 100%
- [x] 시나리오 및 이벤트 대사 번역: 100%
- [ ] 한글 폰트 통합 및 적용: 진행중
- [ ] 시스템 UI
- [ ] 시스템 안정성
- [ ] 플레이 테스트 및 최종 검수
...
| v0.1.0 | 2026-02-25 | 마도물어 하나마루 대유치원아 | 베타 버전 배포 |
