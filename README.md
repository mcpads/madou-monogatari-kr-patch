...
> 이 패치는 선공개용 베타 버전으로 아직 검수가 끝나지 않은 상태입니다. 미번역 요소, 게임 진행에 차질이 생기는 버그가 존재할 수 있습니다.
...
2. [Madou Monogatari (Sega Saturn) KR v0.3.0.bps](https://raw.githubusercontent.com/mcpads/madou-monogatari-kr-patch/main/Madou%20Monogatari%20(Sega%20Saturn)%20KR%20v0.3.0.bps)를 다운로드합니다
3. [Floating IPS (Flips)](https://www.smwcentral.net/?p=section&a=details&id=11474) 등 BPS 패처로 원본 BIN 파일에 한글 패치를 적용합니다

### 적용 방법 (U)

1. **원본 ROM**을 준비합니다 (BIN/CUE 형식, 아래 체크섬으로 올바른 파일인지 확인)
2. [Madou Monogatari (U) (Sega Saturn) KR v0.3.0.bps](https://raw.githubusercontent.com/mcpads/madou-monogatari-kr-patch/main/Madou%20Monogatari%20(U)%20(Sega%20Saturn)%20KR%20v0.3.0.bps)를 다운로드합니다
3. [Floating IPS (Flips)](https://www.smwcentral.net/?p=section&a=details&id=11474) 등 BPS 패처로 원본 BIN 파일에 한글 패치를 적용합니다
...
#### KR 패치 파일 — Madou Monogatari (Sega Saturn) KR v0.3.0.bps

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `2144DF1C`                                                         |
| MD5      | `a20fe1aab4ee6eb7ad4f1dfb9985cc0f`                                 |
| SHA-1    | `6edc733819362e174b5717aebee44650d86084ab`                         |
| 크기     | 4,467,176 bytes (4.3 MB)                                           |

#### KR 패치 적용 후 — Madou Monogatari (Sega Saturn) KR v0.3.0.bin

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `6A1709B3`                                                         |
| MD5      | `add3dea54d24b32c07bc8520adad42c4`                                 |
...
#### KR 패치 파일 — Madou Monogatari (U) (Sega Saturn) KR v0.3.0.bps

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `2144DF1C`                                                         |
| MD5      | `1d9a2bcece5945a468d1c94ab499da67`                                 |
| SHA-1    | `28109619e10b8e00bde411e6764d44ab608dca8f`                         |
| 크기     | 4,467,328 bytes (4.3 MB)                                           |

#### KR 패치 적용 후 — Madou Monogatari (U) (Sega Saturn) KR v0.3.0.bin

| 알고리즘 | 해시                                                               |
| -------- | ------------------------------------------------------------------ |
| CRC32    | `E5964102`                                                         |
| MD5      | `fd774437bd299a0a54ed5bf84c9e2a55`                                 |
| 크기     | 146,308,512 bytes (139 MB)                                         |

### 패치 정보

- 베타 버전: 시나리오/이벤트 대사 번역 상태, **몇몇 시스템 UI 미번역**, 버그 존재 가능성
- 한글 폰트: [Galmuri](https://github.com/quiple/galmuri) 12px 비트맵 (대화), [MaplestoryBold](https://maplestory.nexon.com/Media/Font) 14px (프롤로그), [Dalmoori](https://github.com/RanolP/dalmoori-font) 8px 비트맵 (전투 UI)
